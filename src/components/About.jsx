    ...
    <div className="bg-[#CDEA68] w-full p-20 rounded-tl-3xl rounded-tr-3xl overflow-hidden">
      ...
      <div className="w-full pt-10 border-t-[1px] mt-20 border-[#a8c053] leading-none flex flex-wrap justify-center items-center gap-10">
        <div className="w-full md:w-full lg:w-[40%]">
          ...
          <button className="flex gap-10 items-center px-10 py-4 mt-10 bg-zinc-900 rounded-full text-white">
            Read More
            <div className="w-10 h-10 rounded-full border-[1px] border-zinc-400 flex items-center justify-center uppercase">
        ...
        <div className="w-full md:w-full lg:w-1/2 h-[70vh] rounded-3xl bg-[#c3e937]"></div>
      </div>
    </div>
  );
};
